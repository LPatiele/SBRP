...
class Onibus:
    def __init__(self, garagem):
        self.identificacao= random.randint(1000,3000)
    ...
    def __str__(self):
        ...
        # except :
        return 'Identificacao: ' + str(self.identificacao) + ' Garagem: ' + str(self.garagem.nome)
...
class Parada:
    def __init__(self, escola, id):
        ...
        self.latitude =  round(random.uniform(-1000.0,1000.0), 5) 
        self.longitude = round(random.uniform(-1000.0,1000.0), 5) 
        self.qtAlunos = 0 # random.randint(1,3)
        self.alunos = []
        self.escola = escola
        self.matrizDistancia = {}
...
class Paradatest:
    ...
    def __str__(self):
        return ' Parada ID: '+ str(self.identificador) 